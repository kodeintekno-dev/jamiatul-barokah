...
export default function Program() {
  return (
    <div
      ...
      className="py-20 px-50 flex flex-col gap-10 items-center"
    >
      <div className="flex flex-col gap-5 items-center">
        <h1 className="font-bold text-4xl text-[#48AE3C]">KENAPA PILIH KAMI</h1>
        <h2 className="font-bold text-4xl">Program</h2>
      </div>
      <div className="w-[60%] flex gap-15 items-center">
        <div className="bg-black h-[1px] w-full"></div>
        <img src="/img/collegehat.png" alt="" />
        <div className="bg-black h-[1px] w-full"></div>
      </div>
      <section className="flex gap-15">
        <div className="w-full h-100 px-13 outline-black outline-2 flex flex-col p-5 relative">
          ...
          <p className="font-bold">
            ...
            Tujuannya adalah membantu siswa siap menghadapi tantangan kehidupan
            sehari-hari dan dunia kerja secara mandiri dan percaya diri.
          </p>
          <div className="w-full h-full outline-[#6CB531] outline-2 top-2 left-2 absolute"></div>
        </div>
        <div className="w-full h-100 px-13 outline-black outline-2 flex flex-col p-5 gap-3 relative">
